...
export default function PravidlaPage() {
  return (
    <PageShell
      ...
      active="pravidla"
    >
      {/* Dva vyvážené sloupce na PC: vlevo skupinová fáze (zápasy + pořadí +
          král střelců skupiny), vpravo vyřazovací fáze + speciály + rovnost.
          Na mobilu se sloupce složí pod sebe ve stejném logickém pořadí.
          Flex místo gridu, aby karty různých výšek netvořily velké mezery. */}
